...
{{--
                <ul class="nav navbar-nav navbar-right pull-right">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right arrow-dropdown-menu arrow-menu-right user-list notify-list">
                            --}}{{--<li>
                                <h5>Hi, {{Auth::user()->fullName()}}</h5>
                            </li>--}}{{--
--}}{{--                            <li><a href="/"><i class="ti-settings m-r-5"></i> Main Site</a></li>
                            <li><a href="/profile"><i class="ti-user m-r-5"></i> Profile</a></li>--}}{{--
                            <li><a href="{{ url('/logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i class="ti-power-off"></i> Logout</a>
